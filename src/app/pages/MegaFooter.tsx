...
const MegaFooter = () => {
    ...
    return (
        <footer className="relative w-full bg-[#f5f5f7] text-[#0a0a0a] pt-12 md:pt-24 xl:pt-32 pb-8 flex flex-col items-center overflow-hidden z-10">
            <div className="w-full max-w-vw-safe px-6 md:px-12 flex flex-col justify-between min-h-[40vh] md:min-h-[70vh]">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start gap-12 lg:gap-0">
                    ...
                    <div className="flex flex-col w-full md:flex-1 lg:flex-none lg:w-5/12 gap-4 md:gap-6 pr-0 md:pr-12 lg:pr-0">
                        ...
                        <p className="font-inter text-md lg:text-lg xl:text-xl leading-tight tracking-tight">
                    ...
                    <div className="flex w-full md:w-auto lg:w-5/12 flex-col md:flex-row md:justify-end gap-8 md:gap-24 xl:gap-32">
                        ...
                        {/* Column 1: Socials */}
                        <div className="flex flex-row md:flex-col justify-start items-center md:items-start gap-12 md:gap-6">
                            ...
                            <div className="flex flex-row md:flex-col gap-12 md:gap-6">
                                <a href="mailto:martingaoorglz@gmail.com" className="font-inter text-sm lg:text-md 2xl:text-lg hover:opacity-50 transition-opacity">Email</a>
                                <a href="https://github.com/Martin-Lianzhan-Gao" target="_blank" rel="noreferrer" className="font-inter text-sm lg:text-md 2xl:text-lg hover:opacity-50 transition-opacity">GitHub</a>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-row md:flex-col justify-start items-center md:items-start gap-12 md:gap-6">
                            ...
                            <div className="flex flex-row md:flex-col gap-12 md:gap-6">
                                <div onClick={(e) => scrollToSection('about', e)} className="font-inter text-sm lg:text-md 2xl:text-lg hover:opacity-50 transition-opacity cursor-pointer">About</div>
                                <div onClick={(e) => scrollToSection('works', e)} className="font-inter text-sm lg:text-md 2xl:text-lg hover:opacity-50 transition-opacity cursor-pointer">Works</div>
                            </div>
                        </div>
                    </div>
                </div>
