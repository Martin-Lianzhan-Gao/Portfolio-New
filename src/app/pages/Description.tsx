...
const Description = () => {
    ...
    return (
        <div ref={containerRef} id="about" data-theme="dark" className="theme-dark relative z-20 overflow-x-hidden bg-[#0d0d0d] w-full md:pb-48  flex flex-col items-center">
