...
const Works = () => {
    ...
    return (
        <div ref={containerRef} className="relative z-40 w-full min-h-[100dvh] bg-[#0d0d0d] md:rounded-t-[2rem] -mt-8 md:-mt-12 overflow-hidden flex flex-col justify-start" id="works-section">
