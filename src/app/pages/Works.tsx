...
const Works = () => {
    ...
    return (
        <div ref={containerRef} id="works" className="relative z-20 w-full min-h-[100dvh] bg-[#0d0d0d] overflow-hidden shadow-[0_30px_60px_rgba(0,0,0,0.8)] flex flex-col justify-start">
