...
const Skills = () => {
    ...
    return (
        <section
            ...
            className="relative z-20 w-full bg-[#f5f5f7] overflow-hidden pt-16 sm:pt-20 md:pt-28 lg:pt-40 xl:pt-48 pb-18 md:pb-24 lg:pb-16 xl:pb-28 2xl:pb-36 flex flex-col justify-center"
        >
